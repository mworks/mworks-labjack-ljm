...
class T8DeviceInfo : public DeviceInfo {
    ...
    bool isHighSpeedCounter(int line) const override {
        return (isInRange<PhysicalLine::DIO6, PhysicalLine::DIO8>(line) ||
                line == static_cast<int>(PhysicalLine::DIO10) ||
                isInRange<PhysicalLine::DIO13, PhysicalLine::DIO15>(line));
    }
    ...
    bool isQuadraturePhaseA(int line) const override {
        return (line == static_cast<int>(PhysicalLine::DIO0) ||
                ...
                line == static_cast<int>(PhysicalLine::DIO4) ||
                line == static_cast<int>(PhysicalLine::DIO6) ||
                line == static_cast<int>(PhysicalLine::DIO8) ||
                line == static_cast<int>(PhysicalLine::DIO10) ||
                line == static_cast<int>(PhysicalLine::DIO12) ||
...
std::unique_ptr<DeviceInfo> DeviceInfo::getDeviceInfo(int deviceType) {
    switch (deviceType) {
        case LJM_dtT8:
            return std::make_unique<T8DeviceInfo>();
        case LJM_dtT7:
...
bool T8DeviceInfo::parseLineName(const std::string &name, int &line) const {
